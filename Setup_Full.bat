...
title PDF Optimizer Suite v3.7.0 - Portable Setup
...
echo Starting Portable Installation v3.9.2...
echo --- SETUP LOG v3.9.2 START --- >> "%LOG_FILE%"
...
echo Setup Finished.
echo --- SETUP LOG v3.9.2 END --- >> "%LOG_FILE%"